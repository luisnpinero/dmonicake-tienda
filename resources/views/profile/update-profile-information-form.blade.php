<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="description">
        {{ __('Actualiza tu informacion de perfil, email y numero telefónico.') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="first_name" value="{{ __('Nombre(s)') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="last_name" value="{{ __('Apellidos(s)') }}" />
